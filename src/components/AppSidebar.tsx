...
const navItems: NavItem[] = [
  ...
  { title: "Check-in QR", url: "/app/next-level/check-in", icon: QrCode },
  { title: "Visitantes", url: "/app/next-level/visitantes", icon: UserPlus },
  { title: "Follow-up", url: "/app/next-level/follow-up", icon: UserCheck },
  { title: "Heatmap", url: "/app/next-level/heatmap", icon: Flame },
  { title: "LMS", url: "/app/next-level/lms", icon: GraduationCap },
  { title: "Tareas", url: "/app/next-level/tareas", icon: CheckSquare },
  { title: "Instalaciones", url: "/app/next-level/instalaciones", icon: Building2 },
  { title: "Integraciones", url: "/app/next-level/integraciones", icon: Plug },
  { title: "Marketplace", url: "/app/next-level/marketplace", icon: Store },
  { title: "Geofencing", url: "/app/next-level/geofencing", icon: MapPinned },
  { title: "Pastoral AI", url: "/app/next-level/pastoral-ai", icon: Bot },
  { title: "Insights", url: "/app/next-level/insights", icon: BarChart3 },
